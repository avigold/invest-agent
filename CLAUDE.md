...
- **PRD approval gate**: After writing a PRD, STOP and wait for the user to explicitly validate it. Do NOT begin implementation until the user confirms the PRD is approved. Plan mode approval is not PRD approval — the PRD must be reviewed separately.
